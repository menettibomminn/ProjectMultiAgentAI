...
- [ ] FE-001 — Implementare componente dashboard principale — P0 — 2026-03-01 — depends: []
- [ ] FE-002 — Implementare form approvazione candidate changes — P0 — 2026-03-05 — depends: [FE-001]
- [ ] FE-003 — Implementare vista audit log con filtri — P1 — 2026-03-10 — depends: [FE-001]
...
- [ ] FE-010 — Scrivere test unitari componenti UI — P1 — 2026-03-08 — depends: [FE-001, FE-002]

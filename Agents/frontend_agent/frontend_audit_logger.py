"""Write structured audit log entries for every frontend agent execution.

Each run produces one file: ops/audit/frontend-agent/{timestamp}.json
...
Only UI component metadata is logged.
"""

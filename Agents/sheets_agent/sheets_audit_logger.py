"""Write structured audit log entries for every agent execution.

Each run produces one file: audit/sheets/{agent_id}/{timestamp}.json
Content includes checksums, timestamps, operation details, and runtime metrics.

Design decisions (see ARCHITECTURE.md):
- Timestamps use ISO 8601 UTC.
- Report checksum is SHA-256 of the serialised report JSON.
